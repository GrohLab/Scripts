...
chans = contains(clTable.Properties.VariableNames,{'ch','channels'});
chansInTable = find(chans);
chanInTable = chansInTable(1);
...
if ~isempty(waveFile)
    ...
    if Nbncl
        ...
        save(waveFileName, 'clWaveforms','-append', '-v7.3')
    end
else
    ...
    save(waveFileName, 'clWaveforms', '-v7.3');
end
end
