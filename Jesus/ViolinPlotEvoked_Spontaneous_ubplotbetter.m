...
hold on
plot(zeros(13,1)+0.475,pfr(wruIdx&negMod&signMod,1),'ksquare','MarkerFaceColor',[0 0 0.7])
plot(zeros(13,1)+0.525,pfr(wruIdx&negMod&signMod,2),'kv','MarkerFaceColor',[0.7 0 0])
...
hold on
plot(zeros(107,1)-0.475,pfr(wruIdx,2),'ksquare','MarkerFaceColor',[0.7 0 0])
plot(zeros(107,1)-0.525,pfr(wruIdx,1),'ksquare','MarkerFaceColor',[0 0 0.7])
