h1=subplot(2,1,2)
[yCtrE xCtrE]=ksdensity(evFr(wruIdx&posMod&signMod,1),'Bandwidth',10)
patch(yCtrE*-1,xCtrE,[0 0 1],'EdgeAlpha',0.1,'FaceAlpha',0.7)
hold on
[yAIE xAIE]=ksdensity(evFr(wruIdx&posMod&signMod,2),'Bandwidth',10)
patch(yAIE,xAIE,[1 0 0],'EdgeAlpha',0.1,'FaceAlpha',0.7)
hold on
plot(zeros(8,1)-0.0025,evFr(wruIdx&posMod&signMod,1),'ksquare','MarkerFaceColor',[0 0 0.7])
plot(zeros(8,1)+0.0025,evFr(wruIdx&posMod&signMod,2),'k^','MarkerFaceColor',[0.7 0 0])
...
hold on
plot(zeros(20,1)+0.0475,evFr(wruIdx&negMod&signMod,1),'ksquare','MarkerFaceColor',[0 0 0.7])
plot(zeros(20,1)+0.0525,evFr(wruIdx&negMod&signMod,2),'kv','MarkerFaceColor',[0.7 0 0])
...
hold on
plot(zeros(84,1)-0.0475,evFr(wruIdx,2),'ksquare','MarkerFaceColor',[0.7 0 0])
plot(zeros(84,1)-0.0525,evFr(wruIdx,1),'ksquare','MarkerFaceColor',[0 0 0.7])
...
hold on
plot(zeros(8,1)-0.025,pfr(wruIdx&posMod&signMod,1),'ksquare','MarkerFaceColor',[0 0 0.7])
plot(zeros(8,1)+0.025,pfr(wruIdx&posMod&signMod,2),'k^','MarkerFaceColor',[0.7 0 0])
...
hold on
plot(zeros(20,1)+0.475,pfr(wruIdx&negMod&signMod,1),'ksquare','MarkerFaceColor',[0 0 0.7])
plot(zeros(20,1)+0.525,pfr(wruIdx&negMod&signMod,2),'kv','MarkerFaceColor',[0.7 0 0])
...
hold on
plot(zeros(84,1)-0.475,pfr(wruIdx,2),'ksquare','MarkerFaceColor',[0.7 0 0])
plot(zeros(84,1)-0.525,pfr(wruIdx,1),'ksquare','MarkerFaceColor',[0 0 0.7])
