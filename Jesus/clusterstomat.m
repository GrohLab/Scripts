ClustersControlOnset = nan(2000,size(relativeSpkTmsStruct(6).SpikeTimes(:,1),1));
...
ClustersL200Onset = nan(2000,size(relativeSpkTmsStruct(5).SpikeTimes(:,1),1));
...
ClustersL100Onset = nan(2000,size(relativeSpkTmsStruct(4).SpikeTimes(:,1),1));
...
ClustersL50Onset = nan(2000,size(relativeSpkTmsStruct(3).SpikeTimes(:,1),1));
...
ClustersL10Onset = nan(20000,size(relativeSpkTmsStruct(2).SpikeTimes(:,1),1));
...
ClustersL1Onset = nan(20000,size(relativeSpkTmsStruct(1).SpikeTimes(:,1),1));
