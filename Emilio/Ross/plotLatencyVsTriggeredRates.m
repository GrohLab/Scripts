...
errorbar(mnLat(~tagged),mnRate(~tagged),sdRate(~tagged), sdRate(~tagged), sdLat(~tagged), sdLat(~tagged),...
    'LineStyle', 'none', 'Marker', 'd', 'Color', [0.5, 0.5, 0.5], 'MarkerSize', 2.5, 'LineWidth', 0.01, 'CapSize', 5);
hold on
errorbar(mnLat(tagged),mnRate(tagged),sdRate(tagged), sdRate(tagged),  sdLat(tagged), sdLat(tagged),...
    'LineStyle', 'none', 'Marker', 'd', 'Color', [0.5, 1, 1], 'MarkerSize', 2.5, 'LineWidth', 0.01, 'CapSize', 5);
hold off
